...
public class ConfigValues implements Serializable {
    ...
    public String getIncludedcommimenterms() {
        return includedcommimentterms;
    }

    public void setIncludedcommimenterms(String includedcommimentterms) {
        this.includedcommimentterms = includedcommimentterms;
    }
...
//    @Builder.Default
    ...
    private String includedcommimentterms;
    ...
    public String toString(){
        return "{ \"ConfigValues\" {  \"id\": " + this.id + ", \"keyname\" :" + this.keyname +   ", \"keyvalue\" : " + this.keyvalue +
                ",\"category\": " + this.category +
                ", \"sucategory\": " + this.subcategory + " } }";
